...
coverpkg="github.com/tenderly/op-geth/..."
...
repo=$GOPATH/src/github.com/tenderly/op-geth
compile_fuzzer github.com/tenderly/op-geth/accounts/abi \
  FuzzABI fuzzAbi \
...
compile_fuzzer github.com/tenderly/op-geth/eth/protocols/snap \
...
compile_fuzzer github.com/tenderly/op-geth/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/tenderly/op-geth/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/tenderly/op-geth/tests/fuzzers/bls12381 \
